...
const Navbar: NextPage<NavProps> = ({ setPicture }) => {
    ...
    return (
        <S.Container>
            <S.Nav>
                <S.TitleArea>
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" width="0" height="0" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <S.Title> NASA API Projects </S.Title>
                </S.TitleArea>
                {
                    router.route == "/apod" ?
                        <S.List>
                            <S.Option>
                                <S.DateForm onSubmit={submitHandler}>
